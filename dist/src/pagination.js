...
var PaginationPrevious = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (_jsxs(PaginationLink, __assign({ "aria-label": "Go to previous page", size: "default", className: cn('h-10 gap-1 border border-input bg-background px-4 py-2 pl-2.5 font-bold text-stone-200 hover:bg-accent hover:text-accent-foreground', className) }, props, { children: [_jsx(ChevronLeft, { className: "h-4 w-4" }), _jsx("span", { children: "Previous" })] })));
};
PaginationPrevious.displayName = 'PaginationPrevious';
var PaginationNext = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (_jsxs(PaginationLink, __assign({ "aria-label": "Go to next page", size: "default", className: cn('h-10 gap-1 border border-input bg-background px-4 py-2 pr-2.5 font-bold text-stone-200 hover:bg-accent hover:text-accent-foreground', className) }, props, { children: [_jsx("span", { children: "Next" }), _jsx(ChevronRight, { className: "h-4 w-4" })] })));
};
