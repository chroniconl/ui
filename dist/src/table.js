...
var TableFooter = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (_jsx("tfoot", __assign({ ref: ref, className: cn('bg-muted/50 border-t font-medium [&>tr]:last:border-b-0', className) }, props)));
});
TableFooter.displayName = 'TableFooter';
var TableRow = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (_jsx("tr", __assign({ ref: ref, className: cn('hover:bg-muted/50 border-b transition-colors data-[state=selected]:bg-muted', className) }, props)));
});
